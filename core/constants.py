...
# ============================================================
# SGP呼び径ごとの標準オリフィスプレート厚み [mm]
#   出典: ユーザー提供資料「オリフィスSGPプレート厚み.csv」
#   （内径Dの値は上記 SGP_DIAMETERS と完全一致することを確認済み）
#   呼び径選択（コンボボックス）に連動して plate_t_var へ自動設定される。
#   90A・175Aは元資料に記載が無いため、前後の呼び径（80A/100A、
#   150A/200A）がいずれも同じ値であることから同値を補間して設定。
#   「SGP その他」は板厚不定のため自動設定の対象外（手動入力のまま）。
# ============================================================
SGP_PLATE_THICKNESS = {
    "SGP 10A 3/8B": 1.0,
    "SGP 15A 1/2B": 1.0,
    ...
    "SGP 65A 2 1/2B": 2.0,
    "SGP 80A 3B": 2.0,
    "SGP 90A 3 1/2B": 2.0,   # 元資料に記載なし。80A/100Aから補間
    "SGP 100A 4B": 2.0,
    "SGP 125A 5B": 2.0,
    "SGP 150A 6B": 2.0,
    "SGP 175A 7B": 2.0,      # 元資料に記載なし。150A/200Aから補間
    "SGP 200A 8B": 2.0,
    "SGP 250A 10B": 2.0,
    "SGP 300A 12B": 2.0,
    "SGP 350A 14B": 3.0,
